...
def process_frames(frame_folder, save_folder):
    ...
    for idx, frame_file in enumerate(frame_files):
        ...
        save_path = os.path.join(save_folder, f"processed_{frame_file}")
...
def main():
    ...
    save_folder = filedialog.askdirectory(title="Select Folder to Save Processed Frames")
    if not save_folder:
        print("No save folder selected. Exiting...")
        return

    # Process frames
    result_df = process_frames(frame_folder, save_folder)
